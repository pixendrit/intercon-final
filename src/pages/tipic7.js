...
import img3d from "../assets/image/png/C7/c7-3d-resized.png";
import img2d from "../assets/image/png/C7/c7-2d-resized.png";
          ...
          <Row className="justify-content-center">
            <Col xl="6" lg="7" md="9">
              <div className="section-title text-center mt-5 mb-3 mb-lg-5">
                <h2 className="title gr-text-3 mb-7">Tipi C7</h2>
