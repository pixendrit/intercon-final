...
import img3d from "../assets/image/png/A5-a/a5-3d-resized.png";
import img2d from "../assets/image/png/A5-a/a5-2d-resized.png";
          ...
          <Row className="justify-content-center">
            <Col xl="6" lg="7" md="9">
              <div className="section-title text-center mt-5 mb-3 mb-lg-5">
                <h2 className="title gr-text-3 mb-7">Tipi A5</h2>
